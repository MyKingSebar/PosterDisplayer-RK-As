package com.youngsee.provider;

import android.net.Uri;

public class DbConstants {
    public static final String AUTHORITY              = "com.youngsee.posterdisplayer.provider";
    public static final String DATABASE_NAME          = "posterdisplayer.db";
