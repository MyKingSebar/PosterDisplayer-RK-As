...
public class GifDecoder extends Thread
{
    ...
    private boolean decordDone = false;
    ...
    private void readContents()
    {
        ...
        while (!(decordDone || err()))
        {
            ...
            {
                Log.i("PosterDisplayer", "gifDecord thread is safe eixt.");
                return;
            }
        }
        
        Log.i("PosterDisplayer", "gifDecord thread is terminate.");
    }
